...
global __divbase
global __divbase2
global __divbn		; делений, которое портит делитель (в делителе осаток от деления)
global __divbn2		; деление, которое не портит делитель (частное) 
...
__addone:
	mov esi, ebp
	sub esi, 64			; tau.al
	mov ecx, [ebp + 112] 		; Вычисляем длину в базах tau
